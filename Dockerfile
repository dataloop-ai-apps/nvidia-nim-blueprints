...
USER 1000
ENV HOME=/tmp
RUN pip install langgraph langchain_community langchain_core tavily-python langchain_nvidia_ai_endpoints elevenlabs nvidia-riva-client networkx matplotlib
